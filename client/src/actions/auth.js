...
export const signin = (formData, openSnackbar, setLoading, navigate) => async (dispatch) => {
...
export const signup = (formData, openSnackbar, setLoading, navigate) => async (dispatch) => {
