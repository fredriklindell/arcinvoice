...
const Settings = () => {
  ...
  useEffect(() => {
    dispatch(getProfileByUser({ search: user?.result?._id || user?.result.googleId }))
  }, [location, switchEdit])
      ...
      {switchEdit === 0 && (
        <Container component="main" maxWidth="sm">
          <Paper sx={styles.paper} elevation={0} >
            ...
            <Button variant="outlined" sx={{ margin: '30px', padding: '15px 30px' }} onClick={() => setSwitchEdit(1)}>Edit Profile</Button>
          </Paper>
        </Container>
      )}
        ...
        <Container component="main" maxWidth="sm">
          <Paper sx={styles.paper} elevation={1} >
            <Box sx={styles.avatarContainer}>
              <Avatar src={profile?.logo} alt="" sx={{ width: '100px', height: '100px', ...styles.avatar }} />
            </Box>
            <form style={styles.form} onSubmit={handleSubmit}>
              ...
              <Button fullWidth type="submit" variant="contained" sx={{ marginTop: '30px', padding: '15px 30px' }}>Update Settings</Button>
            </form>
          </Paper>
        </Container>
      )
