      ...
      <form onSubmit={handleSubmit} className="mu-form">
        ...
        <Container sx={styles.headerContainer}>
          <Grid container justifyContent="space-between" alignItems="center">
            <Grid item>
              {profile && <Avatar alt="Logo" variant='square' src={profile?.logo} sx={styles.large} />}
            </Grid>
            <Grid item>
                ...
                {invoiceData.items.map((itemField, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align="right">
                      <IconButton onClick={() => handleRemoveField(index)} size="large">
        ...
        <div className={cssStyles.toolBar}>
          <Container >
            <Grid container>
              <Grid item style={{ marginTop: 16, marginBottom: 8, marginRight: 10 }}>
                <TextField
                  type="text"
                  step="any"
                  name="rates"
