            ...
            <TableBody>
              {(rowsPerPage > 0
                ...
                <TableRow key={row._id} styel={{ cursor: 'pointer' }} >
                  ...
                  <TableCell sx={tableStyle} scope="row" > <Button style={{ textTransform: 'none' }}  > {row.name} </Button></TableCell>
                  <TableCell sx={tableStyle}>{row.email}</TableCell>
                  <TableCell sx={tableStyle}>{row.phone}</TableCell>
                  <TableCell sx={{ ...tableStyle, width: '10px' }}>
                    <IconButton onClick={() => handleEdit(row._id)} size="large">
                      <BorderColorIcon sx={{ width: '20px', height: '20px' }} />
                    </IconButton>
                  </TableCell>
                  <TableCell sx={{ ...tableStyle, width: '10px' }}>
                    <IconButton
                      onClick={() => dispatch(deleteClient(row._id, openSnackbar))}
                      size="large">
                      <DeleteOutlineRoundedIcon sx={{ width: '20px', height: '20px' }} />
                    </IconButton>
                  </TableCell>
                </TableRow>
              ))}
              ...
              {emptyRows > 0 && (
                <TableRow sx={{ height: `${53 * emptyRows}px` }}>
                  <TableCell colSpan={6} />
                </TableRow>
              )}
            </TableBody>
